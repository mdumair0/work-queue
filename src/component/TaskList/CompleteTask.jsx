...
const CompletedTask = ({ data, handleClick, taskNumber, updateTaskStatus, isLoading }) => {
  return (
    data && (
      <div
        className={`flex flex-col justify-between sefl-start flex-shrink-0 h-full p-5 w-[300px] bg-green-400 rounded-xl ${isLoading ? "bg-gray-600": ""}`}
      >
